            ...
            <div x-data="{ activeTab: 'content' }" class="bg-white dark:bg-gray-800 rounded-xl border border-stone-200 dark:border-gray-700 shadow-sm p-6 space-y-6">
                ...
                <div x-show="activeTab === 'content'" class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea wire:model="content" id="content" class="block mt-1 w-full rounded-md shadow-sm border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600" rows="10" required></textarea>
