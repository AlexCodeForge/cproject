    ...
    <div class="min-h-screen flex flex-col lg:flex-row">
        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center p-4 sm:p-6 lg:p-8 relative min-h-screen bg-stone-100 dark:bg-gray-900">
            ...
            <div class="w-full max-w-md mt-12 sm:mt-16 lg:mt-0 text-center">
                <p class="text-9xl font-extrabold text-amber-500 dark:text-orange-400 mb-4">404</p>
                <h1 class="text-3xl sm:text-4xl font-bold text-slate-900 dark:text-white mb-4">¡Ups! Página No Encontrada</h1>
                <p class="text-base sm:text-lg text-slate-600 dark:text-gray-400 mb-8">Lo sentimos, no pudimos encontrar la página que estás buscando.</p>
                <a href="{{ route('dashboard') }}" class="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-white bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-amber-500 dark:focus:ring-offset-gray-800 transition-all duration-200" wire:navigate>
                    Ir al Dashboard
                </a>
            </div>
        </div>
